...
/**
 * Swaps the colors green and blue.
 * 
 * @author Christina Foreman
 * 
 */
public class FilterGreenBlueSwap extends ImageRegionFilter {
			...
			for (int y = 0; y < img.getHeight(); y++)
				for (int x = 0; x < img.getWidth(); x++) {
					...
					if (y >= getMinY() && y <= getMaxY() && x >= getMinX()
						...
						// Swap locations of blue and green and compose the new
						// pixel.
						int newPixel = (redAmount << 16) | (blueAmount << 8)
								| greenAmount;
